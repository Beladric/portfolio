...
selectCVLanguage.addEventListener("change",(event)=>{
    document.getElementById("DownloadButton").href = "https://github.com/Beladric/portfolio/blob/main/resources/CV%20GO%C3%8BTZ%20Kilian%20".concat(event.target.value).concat(".pdf");
